        ...
        {bannerData.map((data, index) => {
          return (
            ...
            >
              ...
              <div
                className="absolute top-0 w-full h-full hidden items-center
              justify-between px-4 group-hover:lg:flex"
              >
                <button
              ...
              <div className="container mx-auto">
                ...
                font-bold rounded mt-4 hover:bg-gradient-to-l from-red-700
